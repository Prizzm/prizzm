class SocialController < ApplicationController
  ...
  def publish_recommendation
    ...
    ActivityLogger.user_recommend_item :from => current_user, :for => [item], :data => [:message => params[:message]] 
  end
  ...
  def send_recommendation_request
    ...
    ActivityLogger.user_ask_item :from => current_user, :for => [item], :data => [:message => params[:message]] 
  end

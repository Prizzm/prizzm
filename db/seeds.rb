...
test1 = Factory :user, {:email => 'test@prizzm.com', :password => 'password', :first_name => 'Test2', :last_name => 'User'}
test2 = Factory :user, {:email => 'test1@prizzm.com', :password => 'password', :first_name => 'Test3', :last_name => 'User'}
test3 = Factory :user, {:email => 'test2@prizzm.com', :password => 'password', :first_name => 'Test4', :last_name => 'User'}
